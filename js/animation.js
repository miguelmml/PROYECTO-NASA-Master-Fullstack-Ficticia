...
window.addEventListener('load', function() {
  ...
  document.styleSheets[0].addRule(".lights-1,.lights-3","background-color: rgb(145, 255, 0);box-shadow: 0 0 10px white");
  document.styleSheets[0].addRule(".lights-2","background-color:  rgb(248, 103, 50);box-shadow: 0 0 10px white");
