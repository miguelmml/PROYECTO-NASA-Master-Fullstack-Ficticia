...
//Listeners para buscar imagenes de dias concretos y para el boton de guardar la imagen
...
//Listener para e selector de dia para grafica y tabla de objetos cercanos
...
//Fetch para transferencias tecnologicas
function getTechTransfer(url,obj) {
  fetch(url)
  .then(res => res.json())
  .then(data => {
  ...
  .catch(err => console.error('Error in fetch getTechTransfer', err));
} 

//Funcion para renderizar la grafica y la tabla de datos
